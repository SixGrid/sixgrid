...
class WebClient extends EventEmitter {
	/** 
	 * @param {Client} client
	 * @param {WebClient.Options} options
	 */
	 ...
	 * @property {string} User-Agent Default Value `esix-api/0.x.x (kate@dariox.club)`
	 * @description Headers that get merged with the default node:https request headers.
	 */
	Headers = {
		"User-Agent": `${this.Client.Product.name}/${this.Client.Product.version} (kate@dariox.club)`
	}
